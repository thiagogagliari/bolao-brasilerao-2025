...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function carregarPalpites(userId) {
        ...
        palpites.forEach(palpite => {
            ...
            li.textContent = `Rodada: ${palpite.rodada}, Jogo: ${palpite.jogo}, Palpite: ${palpite.palpite_mandante} x ${palpite.palpite_visitante}, Primeiro Gol: ${palpite.primeiro_gol}, Jogo em Dobro: ${palpite.jogo_dobro ? 'Sim' : 'Não'}, Pontos: ${pontos}`;
